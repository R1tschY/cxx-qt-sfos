...
mod ffi {
    unsafe extern "C++" {
        ...
        fn adjust(self: &mut QRectF, dx1: f32, dy1: f32, dx2: f32, dy2: f32);
        ...
        fn adjusted(self: &QRectF, dx1: f32, dy1: f32, dx2: f32, dy2: f32) -> QRectF;

        /// Returns the y-coordinate of the rectangle's bottom edge.
        fn bottom(self: &QRectF) -> f32;
        ...
        fn moveBottom(self: &mut QRectF, y: f32);
        ...
        #[rust_name = "move_left"]
        fn moveLeft(self: &mut QRectF, x: f32);
        ...
        fn moveRight(self: &mut QRectF, x: f32);
        ...
        #[rust_name = "move_top"]
        fn moveTop(self: &mut QRectF, y: f32);
        ...
        fn setBottom(self: &mut QRectF, y: f32);
        ...
        fn setCoords(self: &mut QRectF, x1: f32, y1: f32, x2: f32, y2: f32);
        ...
        fn setHeight(self: &mut QRectF, h: f32);
        ...
        #[rust_name = "set_left"]
        fn setLeft(self: &mut QRectF, x: f32);
        ...
        #[rust_name = "set_rect"]
        fn setRect(self: &mut QRectF, x: f32, y: f32, width: f32, height: f32);
        ...
        #[rust_name = "set_right"]
        fn setRight(self: &mut QRectF, x: f32);
        ...
        #[rust_name = "set_top"]
        fn setTop(self: &mut QRectF, y: f32);
        ...
        #[rust_name = "set_width"]
        fn setWidth(self: &mut QRectF, w: f32);

        /// Sets the left edge of the rectangle to the given finite x coordinate.
        /// May change the width, but will never change the right edge of the rectangle.
        #[rust_name = "set_x"]
        fn setX(self: &mut QRectF, x: f32);

        /// Sets the top edge of the rectangle to the given finite y coordinate.
        /// May change the height, but will never change the bottom edge of the rectangle.
        #[rust_name = "set_y"]
        fn setY(self: &mut QRectF, y: f32);
        ...
        fn width(self: &QRectF) -> f32;

        /// Returns the x-coordinate of the rectangle's left edge.
        fn x(self: &QRectF) -> f32;

        /// Returns the y-coordinate of the rectangle's top edge.
        fn y(self: &QRectF) -> f32;
    }
    ...
    unsafe extern "C++" {
        ...
        fn construct(x: f32, y: f32, width: f32, height: f32) -> QRectF;
        #[doc(hidden)]
