...
mod ffi {
    unsafe extern "C++" {
        ...
        fn manhattanLength(self: &QPointF) -> f32;

        /// Sets the x coordinate of this point to the given finite x coordinate.
        #[rust_name = "set_x"]
        fn setX(self: &mut QPointF, x: f32);

        /// Sets the y coordinate of this point to the given finite y coordinate.
        #[rust_name = "set_y"]
        fn setY(self: &mut QPointF, y: f32);
        ...
        fn x(self: &QPointF) -> f32;

        /// Returns the y coordinate of this point.
        fn y(self: &QPointF) -> f32;
    }
    ...
    unsafe extern "C++" {
        ...
        fn qpointfDotProduct(p1: &QPointF, p2: &QPointF) -> f32;
    }
    ...
    unsafe extern "C++" {
        ...
        fn construct(x: f32, y: f32) -> QPointF;
        #[doc(hidden)]
        ...
        fn operatorMul(a: f32, b: &QPointF) -> QPointF;
        #[doc(hidden)]
        #[rust_name = "qpointf_div"]
        fn operatorDiv(a: f32, b: &QPointF) -> QPointF;
    }
}
...
impl QPointF {
    ...
    pub fn dot_product(p1: &QPointF, p2: &QPointF) -> f32 {
...
impl std::ops::Div<f32> for QPointF {
    type Output = Self;
