...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        fn construct(left: f32, top: f32, right: f32, bottom: f32) -> QMarginsF;
        #[doc(hidden)]
        ...
        #[doc(hidden)]
        #[rust_name = "qmarginsf_plus_f32"]
        fn operatorPlus(a: &QMarginsF, b: &f32) -> QMarginsF;
        #[doc(hidden)]
        #[rust_name = "qmarginsf_minus"]
        fn operatorMinus(a: &QMarginsF, b: &QMarginsF) -> QMarginsF;
        #[doc(hidden)]
        #[rust_name = "qmarginsf_minus_f32"]
        fn operatorMinus(a: &QMarginsF, b: &f32) -> QMarginsF;
        #[doc(hidden)]
        #[rust_name = "qmarginsf_mul"]
        fn operatorMul(a: f32, b: &QMarginsF) -> QMarginsF;
        #[doc(hidden)]
        #[rust_name = "qmarginsf_div"]
        fn operatorDiv(a: f32, b: &QMarginsF) -> QMarginsF;
    }
}
...
impl std::ops::Add<f32> for QMarginsF {
    type Output = Self;
    fn add(self, other: f32) -> Self {
        ffi::qmarginsf_plus_f32(&self, &other)
    }
}
...
impl std::ops::Sub<f32> for QMarginsF {
    type Output = Self;
    fn sub(self, other: f32) -> Self {
        ffi::qmarginsf_minus_f32(&self, &other)
    }
}

impl std::ops::Mul<f32> for QMarginsF {
    type Output = Self;
...
impl std::ops::Div<f32> for QMarginsF {
    type Output = Self;
