...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        fn setHeight(self: &mut QSizeF, height: f32);

        /// Sets the width to the given finite width.
        #[rust_name = "set_width"]
        fn setWidth(self: &mut QSizeF, width: f32);
    ...
    unsafe extern "C++" {
        ...
        fn construct(w: f32, h: f32) -> QSizeF;
        #[doc(hidden)]
        ...
        fn operatorMul(a: f32, b: &QSizeF) -> QSizeF;
        #[doc(hidden)]
        #[rust_name = "qsizef_div"]
        fn operatorDiv(a: f32, b: &QSizeF) -> QSizeF;
    }
}
...
impl std::ops::Mul<f32> for QSizeF {
    type Output = Self;
...
impl std::ops::Div<f32> for QSizeF {
    type Output = Self;
